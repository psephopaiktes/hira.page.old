...
## とりあえず結論
お金があるなら SONYの [INZONE H7](https://amzn.to/3dDCnwH) かCORSAIRの [HS70 Bluetooth](https://amzn.to/3T7bO3j)、あまり無いならHORIの [ヘッドセット](https://amzn.to/3dHjtFl) か [イヤフォン](https://amzn.to/3QP14o4) を買っとけばだいたい大丈夫。
...
{{<img alt="イヤフォン通話 + Switchスピーカー" src="0-speaker-and-headphone.webp">}}
...
## 案1: ミキサーの利用
{{<img alt="ミキサーを利用した様子" src="1-mixer-photo.webp">}}
...
{{<img alt="キャプチャボードを利用した様子" src="3-capture-board-photo.webp">}}
...
{{<img alt="SteelSeries ARCTIS 9 WIRELESS" src="4-product-1.webp">}}
...
{{<img alt="Bluetoothミキサーを利用した配線図" src="5-bluetooth-mixer.webp">}}
